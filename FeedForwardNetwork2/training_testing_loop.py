...
from custom_feed_forward_net import CustomFFNv1, CustomFFNv2, CustomFFNv3, CustomFFNv4, CustomFFNv5, CustomFFNv6, CustomFFNv7
...
if __name__ == "__main__":
    ...
    optimizer = torch.optim.Adam(Custom_FFN.parameters(), lr=LEARNING_RATE)
